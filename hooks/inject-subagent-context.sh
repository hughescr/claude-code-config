#!/usr/bin/env bash
# SubagentStart hook: injects SUBAGENT-CLAUDE.md as additionalContext,
# layered user-global then project (mirroring CLAUDE.md layering). Emits
# nothing if neither file exists.
set -euo pipefail

FILE_NAME="SUBAGENT-CLAUDE.md"
...
# is documented as present for every hook event including SubagentStart.
